...
console.log(input);
    ...
    return(
        <>
        <Container className="bg-primary text-center text-light" style={{borderRadius:"10px"}}>
      ...
      <div>
        //buscador
          ...
          //cards
          <Row>
            {movies.length === 0 ? <Container className="bg-dark text-center text-light" style={{height:"450px"}}>
